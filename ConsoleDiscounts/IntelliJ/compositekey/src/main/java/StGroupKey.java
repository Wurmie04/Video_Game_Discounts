...
public class StGroupKey implements WritableComparable<StGroupKey> {
    ...
    public StGroupKey(int date, String type) {
        releaseDate = date;
        gameType = type;
    }
    /*
    ...
    */
    ...
    public int compareTo(StGroupKey o) {    // 1. 0. -1
        if (releaseDate < o.releaseDate) return 1;
            ...
            if ("PS5".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("PS4")) {
                return -1;
            }
            else if ("PS4".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("PS5")) {
                return 1;
            }
            else if("PS5".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("Nintendo")){
                return -1;
            }
            else if("PS4".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("Nintendo")){
                return -1;
            }
            else if("Nintendo".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("PS5")){
                return 1;
            }
            else if("Nintendo".equalsIgnoreCase(gameType) && o.gameType.equalsIgnoreCase("PS4")){
                return 1;
            }
            else{
                return 0;
    ...
    public void write(DataOutput dataOutput) throws IOException {
        ...
        new Text(gameType).write(dataOutput);
    }
    ...
    public void readFields(DataInput dataInput) throws IOException {
        ...
        gameTypeText.readFields(dataInput);
        gameType = gameTypeText.toString();
    }

    //outputs as the Group instead of StKey....
    public String toString() {
        return releaseDate + " " + gameType + " : ";
    }
